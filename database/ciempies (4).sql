...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-09-2025 a las 00:43:42
...
CREATE TABLE `estudiante` (
  ...
  `id_acudiente` bigint(20) DEFAULT NULL,
...
INSERT INTO `estudiante` (`id_estudiante`, `apellido`, `curso`, `direccion`, `discapacidad`, `documento`, `edad`, `eps`, `etnia`, `fecha_inscripcion`, `id_acudiente`, `id_asistencia`, `id_colegio`, `id_inscripcion`, `id_jornada`, `id_ruta`, `nombre`, `sexo`, `telefono`, `activo`, `fecha_registro`) VALUES
(1, 'perez', '3a', 'cll 32 #13a 51', 'n/a', '51651', 13, 'compensar', 'no', NULL, NULL, NULL, NULL, NULL, NULL, 2, 'pepe', 'MASCULINO', '46946514', b'1', NULL),
(2, 'carreño', '2a', 'cll 23 #2 23', 'n/a', '651032', 13, 'compensar', 'no', NULL, NULL, NULL, NULL, NULL, NULL, 3, 'martina', 'FEMENINO', '654651321', b'1', '2025-09-17');
...
(54, 103, 'martina', '	111111', '2025-08-01', 'activo', NULL);
...
(3, 'Ana', 'López', 'ana@cienpies.co', '910110', 'administrador', 3, NULL),
